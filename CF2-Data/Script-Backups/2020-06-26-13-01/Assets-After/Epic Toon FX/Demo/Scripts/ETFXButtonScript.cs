...
//		print(projectileParticleName);
	...
	public bool overButton()		// This function will return either true or false
	{
		...
		if(button1.Contains(new Vector2(ControlFreak2.CF2Input.mousePosition.x, Screen.height - ControlFreak2.CF2Input.mousePosition.y)) ||
		   button2.Contains(new Vector2(ControlFreak2.CF2Input.mousePosition.x, Screen.height - ControlFreak2.CF2Input.mousePosition.y)))
		{
			return true;
		}
		else
