...
namespace ProBuilder2.Examples
{
	public class CameraControls : MonoBehaviour
	{
		...
		void LateUpdate()
		{
			...
			{
				float rot_x = ControlFreak2.CF2Input.GetAxis(INPUT_MOUSE_X);
				float rot_y = -ControlFreak2.CF2Input.GetAxis(INPUT_MOUSE_Y);
			...
			if( ControlFreak2.CF2Input.GetAxis(INPUT_MOUSE_SCROLLWHEEL) != 0f )
			{
				float delta = ControlFreak2.CF2Input.GetAxis(INPUT_MOUSE_SCROLLWHEEL);
