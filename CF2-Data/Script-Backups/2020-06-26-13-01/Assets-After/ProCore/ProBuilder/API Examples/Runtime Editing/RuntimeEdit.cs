...
namespace ProBuilder2.Examples
{
	...
	public class RuntimeEdit : MonoBehaviour
	{
		...
		public void LateUpdate()
		{
			...
			if(ControlFreak2.CF2Input.GetMouseButtonDown(1) || (ControlFreak2.CF2Input.GetMouseButtonDown(0) && ControlFreak2.CF2Input.GetKey(KeyCode.LeftAlt)))
			{
				mousePosition_initial = ControlFreak2.CF2Input.mousePosition;
				dragging = true;
			}

			if(dragging)
			{
				Vector2 delta = (Vector3)mousePosition_initial - (Vector3)ControlFreak2.CF2Input.mousePosition;
			...
			if(ControlFreak2.CF2Input.GetMouseButtonUp(1) || ControlFreak2.CF2Input.GetMouseButtonUp(0))
			{
				dragging = false;
			}
		}
		...
		public void Update()
		{
			if(ControlFreak2.CF2Input.GetMouseButtonUp(0) && !ControlFreak2.CF2Input.GetKey(KeyCode.LeftAlt)) {

				if(FaceCheck(ControlFreak2.CF2Input.mousePosition))
				{
					if(currentSelection.IsValid())
					{
